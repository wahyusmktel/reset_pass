...
@section('title', 'Pengajuan Reset Akun MyLMS')
...
@section('content')
    ...
    <div class="reset-card-anim">
        <div class="text-center mb-4">
            <i class="fas fa-graduation-cap me-2" style="font-size: 56px; color: #db4437; margin-bottom: 8px;"></i>
            <h2 class="fw-bold mb-1" style="font-size: 1.7rem; color: #7b1f23;">Form Pengajuan Reset Akun MyLMS</h2>
            <p class="text-muted" style="font-size: 1.05rem;">Silakan isi data berikut untuk mengajukan reset akun MyLMS
                sekolah Anda.</p>
        </div>
        ...
        @endif
        <form action="{{ route('pengajuan-mylms.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="mb-3">
            ...
            <div class="d-grid gap-2 mt-4">
                <button type="submit" class="btn btn-primary py-2 rounded-3">Kirim Pengajuan</button>
            </div>
        </form>
    </div>
