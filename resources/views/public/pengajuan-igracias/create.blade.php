...
@section('title', 'Pengajuan Reset Akun iGracias')
...
@section('content')
    ...
    <div class="reset-card-anim">
        <div class="text-center mb-4">
            <i class="fas fa-user-graduate me-2" style="font-size: 56px; color: #db4437; margin-bottom: 8px;"></i>
            <h2 class="fw-bold mb-1" style="font-size: 1.7rem; color: #7b1f23;">Form Pengajuan Reset Akun iGracias</h2>
            <p class="text-muted" style="font-size: 1.05rem;">Silakan isi data berikut untuk mengajukan reset akun iGracias
                sekolah Anda.</p>
        </div>
        ...
        @endif
        <form action="{{ route('pengajuan-igracias.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="mb-3">
