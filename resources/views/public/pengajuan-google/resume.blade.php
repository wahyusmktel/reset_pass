...
@section('title', 'Resume Pengajuan Google')
...
<div class="container py-5 d-flex justify-content-center align-items-center min-vh-100">
    <div class="w-100" style="max-width: 480px;">
        <div class="text-center mb-4">
            <img src="https://img.icons8.com/color/96/000000/google-logo.png" alt="Google Logo" style="width:64px;height:64px;">
            <h2 class="fw-bold mt-3 mb-2 gradient-title animate-fadein">Pengajuan Reset Akun Google Berhasil</h2>
        ...
        <div class="card shadow rounded-4 border-0 p-4 bg-white">
            ...
            <div class="mb-3">
                <span class="fw-semibold">Email:</span> <span class="float-end">{{ $data->siswa->email }}</span>
            </div>
            <div class="mb-3">
